# Gap status — `mycelium-cli`

| Field | Value |
|-------|--------|
| **Component** | `mycelium-cli` |
| **Role** | myc toolchain driver |
| **Date** | 2026-07-29 |
...
| **Native twin** | `tzervas/mycelium-cli-myc` under [mycelium-lang-myc](https://github.com/tzervas/mycelium-lang-myc) |
| **Local gap notes** | none |
| **Related issues** | Depends on FFI seam + AOT wire-up for full UX |
